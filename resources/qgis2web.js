...
map.getView().fit([-8025574.702616, -4384739.127447, -8024323.434184, -4384075.314765], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Puntos de problemas  - JJVV  M.Montt</h2>';
        return titleElement;
    })(),
